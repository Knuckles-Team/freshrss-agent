---
name: freshrss-starter
description: >-
  Freshrss API + MCP Server + A2A Server Use when working with Freshrss via this package's MCP
...
license: MIT
tags: [freshrss-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Freshrss Starter Skill

Starter skill for the **Freshrss** package. Use the `mcp-client` universal skill
